...
var AppComponent = (function () {
    function AppComponent() {
        ...
        /*
        sortByData(name:string){
           
            this.employess=this.employess.sort(this.sortByEmployeeName)
        }
        
        sortByEmployeeName(empOne:Employee,empTwo:Employee){
        
        if(empOne.empName>empTwo.empName) return 1;
        else if(empOne.empName===empTwo.empName) return -1;
        else return 0;
        }
